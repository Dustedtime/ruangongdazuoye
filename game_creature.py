...
class Creature(pygame.sprite.Sprite):  # 生物类
    def __init__(self, dictionary, setting):  # 字典dictionary里面存有要实例化的对象的属性
        ...
        self.movex = dictionary['movex']  # 横坐标上的移动标志
        self.movey = dictionary['movey']  # 纵坐标上的移动标志
        self.size = (setting.screen_height * dictionary['size'], setting.screen_height * dictionary['size'])  # 图像大小
        ...
        self.rect.topleft = (setting.screen_width * dictionary['rect'][0], setting.screen_height * dictionary['rect'][1])
